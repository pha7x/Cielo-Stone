...
/**
 * Perform NFC card type A test applied to card machine (L200).
 * @author Thiago Malcher
 */
public class NfcReadCardTypeAUnitTest extends UnitTest {
    ...
    protected boolean executeTest() throws TestPendingException, TestShowMessageException
    {
                ...
                if(mThreadFlag){
                    ...
                    if(i == 2){
                        ...
                        if(ret1 == 0){
                            ...
                            appendTextOutput("NFC tipo A POSITIVO FOI RECONHECIDO COM SUCESSO :)");
        ...
        throw new TestShowMessageException("Aguardando teste do NFC Tipo A ser realizado...", TestShowMessageException.DIALOG_TYPE_TOAST);
    }
    ...
    private void handleCardDetected() {
        ...
        if (mPosCardManager != null) {
            ...
            if (ret == 0 && info.mCardType == PosCardManager.PICCCARD_READER_DETECT_CARD_MODE_A) {
                mThreadFlag = false;
