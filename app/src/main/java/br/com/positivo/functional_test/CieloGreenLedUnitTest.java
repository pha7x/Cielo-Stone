 ...
 */
public class CieloGreenLedUnitTest extends UnitTest {
    private int _blinkCount = 1; // From config xml
    private int _testingLED;
    private int _blinkTimes = 0;
    private static final String GREEN_NODE_PATH_VALUE = "/sys/class/leds/green/brightness";
    ...
    protected boolean executeTest() throws TestPendingException, TestShowMessageException
    {
        ...
        throw new TestShowMessageException(String.format("Quantas vezes o LED %s piscou?", "VERDE"),
    ...
    public void writeGreenString(String value) {
        FileWriter fw = null;
        BufferedWriter bw = null;
        try {
            android.util.Log.i(TAG,"into writestring start");
            fw = new FileWriter(GREEN_NODE_PATH_VALUE, false);
