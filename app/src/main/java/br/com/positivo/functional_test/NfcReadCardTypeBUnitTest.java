...
/**
 * Perform NFC card type B test applied to card machine (L200).
 * @author Thiago Malcher
 */
public class NfcReadCardTypeBUnitTest extends UnitTest {
    ...
    protected boolean executeTest() throws TestPendingException, TestShowMessageException
    {
                ...
                if(mThreadFlag){
                    ...
                    if(i == 2){
                        ...
                        if(ret1 == 0){
                            ...
                            appendTextOutput("NFC TIPO B FOI RECONHECIDO COM SUCESSO!");
        ...
        throw new TestShowMessageException("Aguardando teste do NFC Tipo B ser realizado...", TestShowMessageException.DIALOG_TYPE_TOAST);
    }
    ...
    private void handleCardDetected() {
        ...
        if (mPosCardManager != null) {
            ...
            if (ret == 0 && info.mCardType == PosCardManager.PICCCARD_READER_DETECT_CARD_MODE_B) {
                mThreadFlag = false;
