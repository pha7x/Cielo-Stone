...
public class TestActivity extends android.app.Activity
{
    ...
    /**
     * Return the unit test object for this test activity. May return null if
     * activity was destroyed. <br>DO NOT STORE this object in your activity properties, handlers,
     * broadcast receivers, etc to avoid memory leaks.
     * @param <T>
     * @return
     */
